...
#This app will download the podcast playlist and attempt to sync Titles and links with the podcast.  It will auto-play the audio file (might need to allow auto-play in your browser)
