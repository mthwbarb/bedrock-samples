...
python3.11 -m pip install wheel boto3 streamlit langchain feedparser
...
curl -sS https://d2eo22ngex1n9g.cloudfront.net/Documentation/SDK/bedrock-runtime.zip > sdk.zip
